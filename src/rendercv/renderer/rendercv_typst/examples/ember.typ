...
#regular-entry(
  [
    #strong[Nexus AI] -- San Francisco, CA
...
#regular-entry(
  [
    #strong[NVIDIA Research] -- Santa Clara, CA
...
#regular-entry(
  [
    #strong[Google DeepMind] -- London, UK
...
#regular-entry(
  [
    #strong[Apple ML Research] -- Cupertino, CA
...
#regular-entry(
  [
    #strong[Microsoft Research] -- Redmond, WA
